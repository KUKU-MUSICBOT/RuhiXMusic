...
class App(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("XD_CUTETY")
                await self.one.join_chat("II_MY_HELL_LIFE_II")
                await self.one.join_chat("XD_CUTETY")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("XD_CUTETY")
                await self.one.join_chat("II_MY_HELL_LIFE_II")
                await self.one.join_chat("XD_CUTETY")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("XD_CUTETY")
                await self.one.join_chat("II_MY_HELL_LIFE_II")
                await self.one.join_chat("XD_CUTETY")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("XD_CUTETY")
                await self.one.join_chat("II_MY_HELL_LIFE_II")
                await self.one.join_chat("XD_CUTETY")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("XD_CUTETY")
                await self.one.join_chat("II_MY_HELL_LIFE_II")
                await self.one.join_chat("XD_CUTETY")
            except:
                pass
